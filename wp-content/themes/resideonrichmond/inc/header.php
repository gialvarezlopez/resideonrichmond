<div id="holder_main_menu">
    <div class="wrapHolder">
        <header id="main_menu">
            <?php $header = get_field("gs_header","option"); ?>
            <a href="<?php echo home_url(); ?>">
                <?php if(isset($logo_dark) && $logo_dark == true) { ?>
                    <img src="<?php echo $header['logo_dark']['url']; ?>" class="logo_top"> <!-- <img src="images/logo_brown.png" class="logo_top"> -->
                <?php  }else{ ?>
                    <img src="<?php echo $header['logo_white']['url']; ?>" class="logo_top"> <!-- <img src="images/logo_brown.png" class="logo_top"> -->
                <?php } ?>    
            </a>
